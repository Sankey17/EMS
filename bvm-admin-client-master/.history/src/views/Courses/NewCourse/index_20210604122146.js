...
import {Button, CardBody, CardHeader, Col, FormText, FormGroup, Input, Label, Row} from "reactstrap"
...
class NewCourse extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      name: 'Registration',
      fees: '',
      description: (props.location && props.location.state && props.location.state.description) || '',
          ...
          <CardBody>
            <FormGroup row>
              <Col md="3">
                ...
                <Input type="text" id="text-input" name="course" value={course} onChange={this.handleChange} placeholder="course" />
                <FormText color="danger">{error.course}</FormText>
              </Col>
              <Col md="3">
                <Label htmlFor="fees">Fees:</Label>
                <Input type="number" id="fees" name="fees" value={fees} onChange={this.handleChange} placeholder="fees" />
